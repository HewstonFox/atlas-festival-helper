...
class AtlasFestivalHelperOptions {
    ...
    setupEventListeners() {
        ...
        document.getElementById('event-filtering-toggle').addEventListener('click', () => {
            this.toggleSetting('eventFiltering');
        });
    ...
    updateUI(settings) {
        ...
        this.updateToggle('event-filtering-toggle', settings.eventFiltering);
...
document.addEventListener('DOMContentLoaded', function() {
    new AtlasFestivalHelperOptions();
});
